...
<body>
	...
	<div style="width: 600px;" class="p-5 m-5 mx-auto">
		...
		<form action="${ cl }/createPost" method="post" autocomplete="off" enctype="multipart/form-data">
			<div class="space-y-6">
				<div class="flex justify-between items-center">
					<div>
						<label class="text-gray-800 text-md mb-2 block" for="category">카테고리</label>
					...
					<div>
						<label class="text-gray-800 text-md mb-2 block" for="writer">작성자</label>
				...
				<div>
					<label class="text-gray-800 text-md mb-2 block" for="title">제목</label>
				...
				<div>
					<label class="text-gray-800 text-md mb-2 block" for="content">내용</label>
				...
				<div>
					<label class="text-gray-800 text-md mb-2 block" for="filepath">이미지</label>
					<div class="flex items-center space-x-2">
					    <input type="file" name="filepath" id="filepath" class="text-gray-800 bg-white border 
					    	border-gray-300 w-full text-md px-4 py-3 rounded-md outline-blue-500" />
					</div>
				</div>
			</div>
			<div class="!mt-12">
